...
import { addDoctor, allDoctors, appointmentsAdmin, cancelAppointment, adminDashboard, getDoctorOverview } from "../controllers/adminController.js";
...
adminRouter.get("/doctor-overview/:docId",authAdmin,getDoctorOverview)
